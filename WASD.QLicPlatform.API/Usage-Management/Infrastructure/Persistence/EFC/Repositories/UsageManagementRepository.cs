...
public class UsageManagementRepository(AppDbContext context)
    : BaseRepository<UsageEvents>(context), IUsageManagementRepository
{
    public async Task<IEnumerable<UsageEvents>> findBySource(string source)
    {
